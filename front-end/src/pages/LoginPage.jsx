...
const LoginPage = () => {
  ...
  return (
    ...
    >
      <div className="p-8">
        <h2 className="text-3xl mb-6 font-bold text-center bg-gradient-to-r from-green-400 to-emerald-800 text-transparent bg-clip-text">
          Welcome Back
        </h2>
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center items-center">
        <p className="text-sm text-gray-400">Dont an account?</p>
